...
# This script modified by Termux buddy
#@@2222222
  ...
  `-.\         /'  _ `---'' , . ``---' _  `\         /,-'     
     ``       /     \    ,='/ \`=.    /     \       ''          
           ...
           |   |     /'\_\_\ | /_/_/`\     |   |                
            \   \__, \_     `~'     _/ .__/   /            
             `-._,-'   `-._______,-'   `-._,-'--1.0  
                  Made by-Termux buddy                |lolcat
     echo " "
printf "      \e[1;77m v1.0 coded by github.com/Termuxbuddy/hackcam\e[0m \n"
printf "          \e[1;77m v1.1 This reborn script \e[0m \n"
